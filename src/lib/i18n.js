...
const DICT = {
  fr: {
    ...
    addPanelTitle: 'Ajouter une compétition',
    removeCompetitionAria: 'Retirer {label}',
    lastCompetitionMsg: 'Gardez au moins une compétition active.',
    allCompetitionsActive: 'Toutes les compétitions sont surveillées.',
  ...
  en: {
    ...
    addCompetition: 'Add a competition',
    addPanelTitle: 'Add a competition',
    removeCompetitionAria: 'Remove {label}',
    lastCompetitionMsg: 'Keep at least one competition active.',
    allCompetitionsActive: 'All competitions are being watched.',
